...
:page-tags: manual, instructions
:page-illustration: fa-solid fa-tasks
:description: Instructions pour la soumission des rapports de stage M1 et M2, y compris le workflow GitHub et les fichiers PDF requis.
