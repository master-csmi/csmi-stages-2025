 ...
 - [[[PortilloNavarrete]]] Portillo Navarrete Jose Rene, _Shift Technology_, link:https://www.shift-technology.com/[Shift Technology], xref:attachment$Portillo-Jose.pdf[Portillo-Jose.pdf], xref:attachment$Portillo-Jose-slides.pdf[Portillo Navarrete-Jose Rene-slides.pdf]
